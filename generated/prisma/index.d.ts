...
export namespace Prisma {
  ...
  */
    ...
    model: {
      ...
      Feed: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.FeedFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.FeedAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type PostOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "title" | "body" | "heroImage", ExtArgs["result"]["post"]>
  ...
  interface PostFieldRefs {
    ...
    readonly heroImage: FieldRef<"Post", 'String'>
  }
  ...
  export type FeedOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "url" | "items" | "createdAt", ExtArgs["result"]["feed"]>
  ...
  export interface FeedDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more Feeds that matches the filter.
     * @param {FeedFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const feed = await prisma.feed.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: FeedFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a Feed.
     * @param {FeedAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const feed = await prisma.feed.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
     * })
     */
    aggregateRaw(args?: FeedAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  interface FeedFieldRefs {
    ...
    readonly url: FieldRef<"Feed", 'String'>
    readonly items: FieldRef<"Feed", 'String'>
   ...
   * Feed findRaw
   */
  export type FeedFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
   ...
   * Feed aggregateRaw
   */
  export type FeedAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export type PostWhereInput = {
    ...
    heroImage?: StringNullableFilter<"Post"> | string | null
  }
  ...
  export type PostScalarWhereWithAggregatesInput = {
    ...
    heroImage?: StringNullableWithAggregatesFilter<"Post"> | string | null
  }
  ...
  export type FeedScalarWhereWithAggregatesInput = {
    ...
    url?: StringWithAggregatesFilter<"Feed"> | string
    items?: StringWithAggregatesFilter<"Feed"> | string
